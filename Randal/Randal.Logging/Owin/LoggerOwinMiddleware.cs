...
namespace Randal.Logging.Owin
{
	public sealed class LoggerOwinMiddleware : OwinMiddleware, IDisposable
	{
		...
		public LoggerOwinMiddleware(OwinMiddleware next, ILogger logger, ILoggerOwinFormatter formatter)
			: base(next)
		{
			_logger = logger;
			_formatter = formatter ?? new LoggerOwinFormatter();
		}
		...
		private readonly ILoggerOwinFormatter _formatter;
	}
}