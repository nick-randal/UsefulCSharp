...
namespace Randal.Core.Dynamic
{
    ...
    {
        private static readonly Func<Dictionary<string, object>, object> StandardDictionaryConverter = fromDictionary => fromDictionary.ToDictionary(entry => entry.Key, entry => entry.Value);
