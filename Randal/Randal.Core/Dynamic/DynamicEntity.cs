...
namespace Randal.Core.Dynamic
{
	public sealed class DynamicEntity : DynamicObject
	{
		...
		public DynamicEntity(MissingMemberBehavior missingMemberBehavior = MissingMemberBehavior.ThrowException, IDynamicEntityConverter converter = null, IEqualityComparer<string> comparer = null)
		{
